#!/bin/bash -l
#SBATCH --job-name=SumCSE_ORTHO_2_08
#SBATCH --output=./results_new/ortho/02_08_ORTHO_v1.log
...
# Run the training script for the ortho loss experiment.
./scripts/simcse_train_test.sh 4 ../result/SumCSE_ortho_2_08_V1/ \
