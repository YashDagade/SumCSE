#!/bin/bash
#SBATCH --job-name=SumCSE_ORIGINAL_2_07
#SBATCH --output=./results_new/original/02_07_ORIGINAL.log
...
# Run the training script using 4 GPUs and an output directory specific to this experiment.
./scripts/simcse_train_test.sh 4 ../result/SumCSE_original_2_07/ \
